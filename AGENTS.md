...
This project is indexed by GitNexus as **futuopend** (222 symbols, 202 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
